...
const DropAnswer = ({
  ...
  handleDeleteQuetionButton,
  handleCheckRadioAnswerButton
} ) => {
   const Answer = () => {
  ...
  return (
    <div className="dropdown">
        <a onClick={Answer} className="btn btn-warning dropdown-toggle" 
        href="#" 
        role="button" 
        ...
        <ul className="dropdown-menu">
          ...
          <li>
            ...
            <div className="input-group">
            <button 
             onClick={handleCheckRadioAnswerButton} 
             type="button" 
        ...
        <button 
        onClick={handleEditQuestionButton} 
        type="button" 
        className="btn btn-outline-primary btn-lg text-center">
          <i className="bi bi-pencil-square"></i>
        </button>
        <button 
        onClick={handleDeleteQuetionButton} 
        type="button" 
